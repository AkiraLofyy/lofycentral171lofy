    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-body text-center">
          <h4 class="mb-2"><strong>Central F - Checker AllBins (Amazon)</strong></h4>
          <textarea rows="5" class="form-control text-center form-checker mb-2" placeholder="Insira sua Lista"></textarea>

<div class="input-group mb-1">
          <input type="text" class="form-control" id="cookie1" placeholder="Cookie Amazon (US)" name="cookie1">&nbsp;       
                 </div>
...
Swal.fire({ title: "AVISO", text: "Este checker possui cx2!", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
